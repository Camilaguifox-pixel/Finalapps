...
export const CATEGORIAS: Categoria[] = [
    {
        ...
        productos: [{
          ...
          id: 1,          
          precio: 36800,          
          descripcion: "Máscara de pestañas icónicade la Maison, ahora recargable y con una fórmula enriquecida con aguafloral de aciano. Contribuye a nutrir y fortalecer las pestañas, desplegándolas para un volumen y una curva espectacular durante 24 horas.Tono090 Black. ",
        ...
        },
        {
          ...
          id: 3,
          precio: 38390,
          descripcion: "Una base de maquillaje y corrector en una forma natural, dejando un look más que perfecto que dura por 24 horas. Un poco sirve para mucho! 30 ml - Nuestra filosofía de pureza Sin parabenos. Sinftalatos. Sin fragancia. Piel simplemente feliz.",
        ...
        },
        {
          ...
          id: 6,
          precio: 47290,
          descripcion: "Inspirada en la energía detrás del escenario en los desfiles de Dior, esta paleta de maquillaje combina 9 sombras de ojos ultra pigmentadas y fáciles de difuminar con acabados mate, nacarados, metálicos, holográficos y brillantes. Cada armonía es la interpretación de un tema cromático, disponible en tonos complementarios para lograr multitud de looks.",
    ...
    },
    {
        ...
        productos: [
          ...
          },
          {
            ...
            id: 9,
            precio: 80000,
            descripcion: "La primera crema de alta reparación que revierte visiblemente los signos de la edad. La textura aterciopelada de esta crema, compuesta por un 94 % de ingredientes de origen natural, revela una firma olfativa única al servicio de la piel y los sentidos: al aplicarla, Dior Prestige La Crème proporciona un estado de relajación excepcional.",
        ...
        productos: [
          {
            ...
            id: 13,
            precio: 72400,
            descripcion: "30 ml - Un aroma floral luminoso, alegre, asentado y decidido. Armoniza flores como la Champaca (variedad de magnolia de la India, de olor fresco, afrutado y exótico), la violeta de Francia y la orquídea cristalizada. Como fondo, la madera de amaranto, cuyo aroma recuerda al del lavel con más madera y suavidad; se armoniza con una nota de vino dulce de Banyulsy ciruela confitada.",
          ...
          },
          {
            ...
            id: 14,
            precio: 77400,
            descripcion: "50 ml - Su fragancia es intensamente amaderada y masculina, deja una huella duradera. De diseño artístico y sofisticado, Dior Homme representa a un hombre seguro de su energía, pero también de su ternura.Una nueva y masculina sensualidad es redefinida por la armonía de la madera cruda y suave.",
            imagen:
          ...
          },
          {
            ...
            id: 16,
            precio: 106400,
            descripcion: "80 ml - La fragancia GOOD GIRL está inspirada por la visión única de Carolina Herrera de la dualidad de la mujer moderna: audaz y sexy, elegante yenigmática, buena y mala. Siempre forzando y traspasando los límites, la misteriosa sensualidad de GOOD GIRL hace que sea una fragancia moderna y sofisticada a la vez. Notas de entrada: Almendra. Notas de corazón:Ylang-ylang y Jazmín Sambac. Notas de salida: Haba Tonka y Cocoa.Aroma: Oriental / Floral.",
            imagen:
          ...
          },
          {
            ...
            id: 17,
            precio: 145400,
            descripcion: "200 ml - Eros EDT es la fragancia que interpreta la sublime masculinidad atravésde un aura luminosa con una frescura intensa, vibrante y resplandeciente, obtenida de la combinación de hojas de menta, cáscarade limón italiano y manzana verde. Una adictiva sensualidad gracias alas notas orientales, intrigantes y envolventes de las habas tonka, el ámbar, la flor de geranio y la vainilla. Una enérgica virilidad simbolizada por maderas como el cedro de Atlas y Virginia, el vetiver y el musgo de roble, que proporcionan intensidad y potencia.",
            imagen:
